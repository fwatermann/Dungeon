...
public abstract class Level {
  ...
  public final Block blockAt(Vector3i position) {
    return this.blockAt(position.x, position.y, position.z);
  }

  public final Block blockAt(float x, float y, float z) {
    return this.blockAt((int) x, (int) y, (int) z);
  }

  public final Block blockAt(Vector3f position) {
    return this.blockAt(position.x, position.y, position.z);
  }
